...
us to load only the required module for the platform at runtime.
                                                ...
                                                |--> if iOS,load ios/MySlider.ts
                                                |
MySliderExtension -> MySliderPlugin/MySlider ---|
                                                |
                                                |--> if android, load android/MySlider.ts

You can replicate this structure for other controls you'd like to implement
*/
