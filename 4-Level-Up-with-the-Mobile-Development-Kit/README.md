...
|  [6-Enable-Push-Notifications-in-the-MDK-Public-Store-Client](/4-Level-Up-with-the-Mobile-Development-Kit/6-Enable-Push-Notifications-in-the-MDK-Public-Store-Client) | Create a fully functional CRUD native mobile application for iOS and Android| [Enable Push Notifications in the MDK Public Store Client](https://developers.sap.com/tutorials/cp-mobile-dev-kit-push.html)
